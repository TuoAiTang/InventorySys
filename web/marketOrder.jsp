            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <span style="font-size: 2.0em; color: #000055;">等待发货</span>
                        <br><br>
                        ...
                        <div class="card shadow mb-4">
                          ...
                          <em>库存充足</em>
                                    ...
                                    <div>
                                        ...
                                        <c:if test="${order.status == '已付款，待发货'}">
                                        <a href="Marketing.do?method=solve&&cod_id=${order.id}" class="btn btn-danger btn-icon-split" style="float: right;">
                            <span class="icon text-white-50">
                              <i class="fas fa-check"></i>
                            </span>
                                            <span class="text">一键发货</span>
                                        </a>
                                        </c:if>
                                        <c:if test="${order.status == '已发货，待签收'}">
                                            <a href="#" class="btn btn-info btn-icon-split" style="float: right;">
                            <span class="icon text-white-50">
                              <i class="fas fa-check"></i>
                            </span>
                                                <span class="text">已发货，待签收</span>
                                            </a>
                                        </c:if>
                                    </div>
                                </li>
                    ...
                    <div class="col-lg-6 mb-4">
                        <i class="fas fa-fw fa-table"></i>
                        <span style="font-size: 2.0em; color: #000055;">暂缓发货</span>
                        <br><br>
                        <div class="card shadow mb-4">
                          ...
                          <em>库存不足</em>
                                    ...
                                    <div>
                                        ...
                                        <i class="fas fa-info-circle"></i>
                                        <span style="float: bottom"><em>订单编号： ${order.id}</em></span>
                                        <a href="Marketing.do?method=progress&&cod_id=${order.id}" class="btn btn-secondary btn-icon-split" style="float: right;">
                          <span class="icon text-white-50">
