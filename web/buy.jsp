            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <span style="font-size: 2.0em; color: #000055;">线上购买</span>
                        <br><br>
                        <div class="card shadow mb-4">
<%--                            <ul class="list-group list-group-flush">--%>
                            <c:forEach items="${warehouses}" var="wh"  varStatus="st">
                            <li class="list-group-item border-bottom-primary">
                                <div>
                                    <i class="fas fa-fw fa-cog"></i>
                                        <span style="font-size: 1.5em; color: blue;">${wh.goods_name}</span>
                                    <span class="text" style="font-size: 1.5em; float: right;">
                                    <em>剩余${wh.amount}件</em>
                                    </span>
                                </div>
                                <div>
                                    <br>
                                    <i class="fas fa-info-circle"></i>
                                    <span style="float: bottom"><em>销量<%= ut.getSales()%></em></span>
                                    <%  response.setCharacterEncoding("UTF-8");
                                        response.setContentType("text/html;charset=UTF-8");
                                        request.setCharacterEncoding("UTF-8");
                                    %>
                                    <a href="customerBuy.jsp?goods_name=${wh.goods_name}" class="btn btn-danger btn-icon-split" style="float: right;">
...
<%--                            </ul>--%>
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <span style="font-size: 2.0em; color: #000055;">线下门店</span>
                        <br><br>
                        <div class="card shadow mb-4">
                            <c:forEach items="${stores}" var="s" varStatus="st">
                                <li class="list-group-item border-bottom-primary">
                                    <div>
                                        <span style="font-size: 1.5em; color: blue;">${s.key}</span>
                                    </div>
                                    <div>
                                        <br>
			                    ...
			                    <span class="icon text-white-50">
			                      <i class="fas fa-flag"></i>
                                            ...
                                            <span class="text">距离<%=ut.getDistance()%>km</span>
                                        </a>
                                        <a href="#" class="btn btn-info btn-icon-split" style="float: right;">
			                    <span class="icon text-white-50">
			                      <i class="fas fa-info-circle"></i>
			                    </span>
                                            <span class="text">在这里你可以买到${s.value}种零件</span>
                                        </a>
                                    </div>
                                </li>
                            </c:forEach>
