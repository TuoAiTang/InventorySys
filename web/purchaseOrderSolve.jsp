            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <span style="font-size: 2.0em; color: #000055;">采购请求</span>
                        <br><br>
                            ...
                            <c:forEach items="${orders}" var="o" varStatus="st">
                                <li class="list-group-item border-bottom-primary">
                                    <div>
                                        ...
                                        <span style="font-size: 1.5em; color: blue;">${o.goods_name}</span>
                                    ...
                                    <div>
                                        ...
                                        <span style="float: bottom"><em>商品数量 ${o.amount}</em></span>
                                        <span class="text">
                                        <em>时间： ${o.date}</em>
                                        </span>
                                        <a href="Supplier.do?method=solve&&order_id=${o.id}" class="btn btn-danger btn-icon-split" style="float: right;">
                                        <span class="icon text-white-50">
                                        <i class="fas fa-check"></i>
                                        </span>
                                            <span class="text">立即发货</span>
                                        </a>
                                    </div>
                                </li>
                            </c:forEach>
