            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <span style="font-size: 2.0em; color: #000055;">等待调拨</span>
                        <br><br>

                        <div class="card shadow mb-4">
                            <c:forEach items="${readyOrder}" var="order" varStatus="st">
                                <li class="list-group-item border-bottom-primary">
                                    <div>
                                        <i class="fas fa-fw fa-cog"></i>
                                        <span style="font-size: 1.5em; color: blue;">${order.goods_name}</span>
                                        <span class="text" style="font-size: 1.5em;">
                                        <em>门店： ${order.offline_name}</em>
                                        </span>
                                        <span class="text">需求${order.amount}件</span>
                                        <span class="text" style="font-size: 1.5em; float: right;">
                          <em>库存充足</em>
                        </span>
                                    </div>
                                    <div>
                                        ...
                                        <span style="float: bottom"><em>订单编号： ${order.id}</em></span>
                                        <c:if test="${order.status == '加入发货队列'}">
                                            <a href="Purchase.do?method=alloc&&ar_id=${order.id}" class="btn btn-danger btn-icon-split" style="float: right;">
                                                <span class="icon text-white-50">
                                                  <i class="fas fa-check"></i>
                                                </span>
                                                <span class="text">一键调拨</span>
                                            </a>
                                        </c:if>
                                        <c:if test="${order.status == '已调拨，待收货'}">
                                            <a href="#" class="btn btn-info btn-icon-split" style="float: right;">
                                                <span class="icon text-white-50">
                                                  <i class="fas fa-check"></i>
                                                </span>
                                                <span class="text">已调拨，待收货</span>
                                            </a>
                                        </c:if>
                    ...
                    <div class="col-lg-6 mb-4">
                        <i class="fas fa-fw fa-table"></i>
                        <span style="font-size: 2.0em; color: #000055;">暂缓调拨</span>
                        <br><br>
                        <div class="card shadow mb-4">
                            <c:forEach items="${waitOrder}" var="order" varStatus="st">
                                <li class="list-group-item border-bottom-primary">
                                    <div>
                                        <i class="fas fa-fw fa-cog"></i>
                                        <span style="font-size: 1.5em; color: blue;">${order.goods_name}</span>
                          ...
                          <em>库存不足</em>
                                    ...
                                    <div>
                                        ...
                                        <i class="fas fa-info-circle"></i>
                                        <span style="float: bottom"><em>订单编号： ${order.id}</em></span>
                                        <a href="Purchase.do?method=progress&&ar_id=${order.id}" class="btn btn-secondary btn-icon-split" style="float: right;">
                          <span class="icon text-white-50">
                            <i class="fas fa-arrow-right"></i>
                          </span>
                                            <span class="text">查看补货进度</span>
                                        </a>
                                    </div>
                                </li>
                            </c:forEach>
