            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <span style="font-size: 2.0em; color: #000055;">补货情况</span>
                        <br><br>
                        <c:if test="${purchaseOrders == null}">
                            <div class="card shadow" style="margin: 0 auto; text-align: center">
                                <br>
                                <h2>该商品暂时没有发起补货</h2>
                                <br>
                            </div>
                        ...
                        <c:forEach items="${purchaseOrders}" var="order" varStatus="st">
