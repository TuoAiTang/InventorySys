            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <span style="font-size: 2.0em; color: #000055;">下单采购</span>
                        <br><br>

                        <div class="card shadow mb-4">
                            <c:forEach items="${supp_list}" var="goods" varStatus="st">
                            <li class="list-group-item border-bottom-primary">
                                <div>
                                    <i class="fas fa-fw fa-cog"></i>
                                    <span style="font-size: 1.5em; color: blue;">${goods.goods_name}</span>
                                    <span class="text" style="font-size: 1.5em; float: right;">
                                        <em>供应商库存 ${goods.amount}</em>
                                    </span>
                                </div>
                                <div>
                                    <br>
                                    <i class="fas fa-info-circle"></i>
                                    <span style="float: bottom"><em>累计订单 <%=ut.getSales()%></em></span>
                                    <a href="purchaseBuy.jsp?goods_name=${goods.goods_name}&&price=${goods.price}" class="btn btn-danger btn-icon-split" style="float: right;">
                                        <span class="icon text-white-50">
                                        <i class="fas fa-check"></i>
                                        </span>
                                        <span class="text">立即采购</span>
                                    </a>
                                </div>
                            </li>
                            </c:forEach>
