            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <span style="font-size: 2.0em; color: #000055;">处理采购单</span>
                        <br><br>
                            ...
                            <c:forEach items="${orders}" var="order" varStatus="st">
                                <li class="list-group-item border-bottom-primary">
                                    <div>
                                        ...
                                        <em>数量 ${order.amount}</em>
                                        </span>
                                    </div>
                                    <div>
                                        <br>
                                        <i class="fas fa-info-circle"></i>
                                        <span style="float: bottom"><em>供应商已发货</em></span>
                                        <a href="Purchase.do?method=sign_for&&order_id=${order.id}" class="btn btn-danger btn-icon-split" style="float: right;">
                                        <span class="icon text-white-50">
                                        <i class="fas fa-check"></i>
                                        </span>
                                            <span class="text">立即签收</span>
                                        </a>
                                    </div>
                                </li>
                            </c:forEach>
